...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://seguimiento-trabajos-3979.tininimax.chatgpt.site/og.png', width: 1200, height: 630, alt: 'Seguimiento de trabajos — Avance del cronograma operativo 2026' }],
  },
  twitter: {
